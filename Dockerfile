...
LABEL maintainer="Razvan Sima <razvan@doitmagic.com>"
...
RUN apk add --update curl libzip-dev curl-dev nodejs nodejs-npm &&\
    apk del gcc g++ &&\
    rm -rf /var/cache/apk/*
...
ln -sfn /etc/php7/php.ini /etc/php7/conf.d/php.ini
